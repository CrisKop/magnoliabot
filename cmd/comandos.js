...
let prefix_db = new db.crearDB("prefixes")
  ...
  if(args[0] === "staff") {
   ...
   if(args[0] === "config") {
    ...
    .addField("Comandos/Config:", "`setprefix` - `resetprefix` - `createrole` - `menu` - `setautorole` - `setsugerencia`")
    message.channel.send(staff)
  }
  if(args[0] === "seguridad") {
